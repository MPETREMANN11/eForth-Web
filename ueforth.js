...
: free. ( nf nu -- ) 2dup swap . ." free + " . ." used = " 2dup + . ." total ("
                     over + 100 -rot */ n. ." % free)" ;
: raw-ok   ."  v7.0.7.21 - rev cb5da2542a5132448fba09b0cd640dd715299f4b" cr
...
function InitDictionary() {
  ...
  Builtin("-1", 8, 1, 47);
  Builtin("nip", 8, 0, 48);
  Builtin("rdrop", 8, 0, 49);
  Builtin("*/", 8, 0, 50);
  Builtin("*", 8, 0, 51);
  Builtin("/mod", 8, 0, 52);
  Builtin("/", 8, 0, 53);
  Builtin("mod", 8, 0, 54);
  Builtin("invert", 8, 0, 55);
  Builtin("negate", 8, 0, 56);
  Builtin("-", 8, 0, 57);
  Builtin("rot", 8, 0, 58);
  Builtin("-rot", 8, 0, 59);
  Builtin("?dup", 8, 0, 60);
  ...
  Builtin("+!", 8, 0, 76);
  Builtin("cell+", 8, 0, 77);
  Builtin("cells", 8, 0, 78);
  Builtin("cell/", 8, 0, 79);
  Builtin("2drop", 8, 0, 80);
  Builtin("2dup", 8, 0, 81);
  Builtin("3dup", 8, 0, 82);
  Builtin("2@", 8, 0, 83);
  Builtin("2!", 8, 0, 84);
  Builtin("cmove", 8, 0, 85);
  Builtin("cmove>", 8, 0, 86);
  Builtin("fill", 8, 0, 87);
  Builtin("erase", 8, 0, 88);
  Builtin("blank", 8, 0, 89);
  Builtin("min", 8, 0, 90);
  Builtin("max", 8, 0, 91);
  Builtin("abs", 8, 0, 92);
  Builtin("here", 8, 0, 93);
  Builtin("allot", 8, 0, 94);
  Builtin(",", 8, 0, 95);
  Builtin("c,", 8, 0, 96);
  Builtin("'heap", 8, 1, 97);
  Builtin("current", 8, 0, 98);
  Builtin("'context", 8, 1, 99);
  Builtin("'latestxt", 8, 1, 100);
  Builtin("'notfound", 8, 1, 101);
  Builtin("'heap-start", 8, 1, 102);
  Builtin("'heap-size", 8, 1, 103);
  Builtin("'stack-cells", 8, 1, 104);
  Builtin("'boot", 8, 1, 105);
  Builtin("'boot-size", 8, 1, 106);
  Builtin("'tib", 8, 1, 107);
  Builtin("#tib", 8, 0, 108);
  Builtin(">in", 8, 0, 109);
  Builtin("state", 8, 0, 110);
  Builtin("base", 8, 0, 111);
  Builtin("'argc", 8, 1, 112);
  Builtin("'argv", 8, 1, 113);
  Builtin("'runner", 8, 1, 114);
  Builtin("'throw-handler", 8, 1, 115);
  Builtin("context", 8, 0, 116);
  Builtin("latestxt", 8, 0, 117);
  Builtin("[", 9, 0, 118);
  Builtin("]", 9, 0, 119);
  Builtin("literal", 9, 0, 120);
  Builtin("NOP", 8, 1, 121);
  Builtin("0=", 8, 0, 122);
  Builtin("0<", 8, 0, 123);
  Builtin("U<", 8, 0, 124);
  Builtin("+", 8, 0, 125);
  Builtin("U/MOD", 8, 0, 126);
  Builtin("*/MOD", 8, 0, 127);
  Builtin("LSHIFT", 8, 0, 128);
  Builtin("RSHIFT", 8, 0, 129);
  Builtin("ARSHIFT", 8, 0, 130);
  Builtin("AND", 8, 0, 131);
  Builtin("OR", 8, 0, 132);
  Builtin("XOR", 8, 0, 133);
  Builtin("DUP", 8, 0, 134);
  Builtin("SWAP", 8, 0, 135);
  Builtin("OVER", 8, 0, 136);
  Builtin("DROP", 8, 0, 137);
  Builtin("@", 8, 0, 138);
  Builtin("SL@", 8, 0, 139);
  Builtin("UL@", 8, 0, 140);
  Builtin("SW@", 8, 0, 141);
  ...
  Builtin("R>", 8, 0, 153);
  Builtin("R@", 8, 0, 154);
  Builtin("EXECUTE", 8, 0, 155);
  Builtin("BRANCH", 8, 1, 156);
  Builtin("0BRANCH", 8, 1, 157);
  Builtin("DONEXT", 8, 1, 158);
  Builtin("DOLIT", 8, 1, 159);
  Builtin("DOSET", 8, 1, 160);
  Builtin("DOCOL", 8, 1, 161);
  Builtin("DOCON", 8, 1, 162);
  Builtin("DOVAR", 8, 1, 163);
  Builtin("DOCREATE", 8, 1, 164);
  Builtin("DODOES", 8, 1, 165);
  Builtin("ALITERAL", 8, 1, 166);
  Builtin("CELL", 8, 0, 167);
  Builtin("LONG-SIZE", 8, 1, 168);
  Builtin("FIND", 8, 0, 169);
  Builtin("PARSE", 8, 0, 170);
  Builtin("S>NUMBER?", 8, 1, 171);
  Builtin("CREATE", 8, 0, 172);
  Builtin("VARIABLE", 8, 0, 173);
  Builtin("CONSTANT", 8, 0, 174);
  Builtin("DOES>", 8, 0, 175);
  Builtin("IMMEDIATE", 8, 0, 176);
  Builtin(">BODY", 8, 0, 177);
  Builtin("'SYS", 8, 1, 178);
  Builtin("YIELD", 8, 1, 179);
  Builtin(":", 8, 0, 180);
  Builtin("EVALUATE1", 8, 1, 181);
  Builtin("EXIT", 8, 0, 182);
  Builtin("'builtins", 8, 1, 183);
  Builtin(";", 9, 0, 184);
      ...
      decode: for (;;) {
        ...
        switch (ir&0xff) {
          ...
          case 82:  // 3dup
            sp = (sp + 12) | 0;
            i32[(sp - 8)>>2] = (tos|0);
            i32[(sp - 4)>>2] = (i32[(sp - 16)>>2]|0);
            i32[sp>>2] = (i32[(sp - 12)>>2]|0);
            break;
          case 83:  // 2@
            (sp = (sp + 4) | 0, i32[sp>>2] = (tos|0));
